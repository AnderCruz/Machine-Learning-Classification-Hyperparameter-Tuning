...
* **Exploratory Data Analysis (EDA)**
  Statistical summaries, correlation analysis, and visualizations to better understand feature relationships.
...
* **Hyperparameter Tuning**
  Advanced tuning strategies were applied using:

  * `GridSearchCV`
  * `RandomizedSearchCV`
  * `Bayesian Optimization` with `BayesSearchCV` (via `scikit-optimize`)
...
* Optimize performance through careful feature engineering and hyperparameter search
* Showcase practical skills in machine learning, EDA, and model interpretability
